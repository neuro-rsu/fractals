...
customElements.define('fractal-button', class FractalButton extends FractalElement {
    ...
    get _icon() {
        ...
        return html`<fractal-icon class="${this.toggled ? this.toggledClass : this.notoggledClass}" icon=${_icon} name="${this.name}" fill="${this.fill}" size="${this.size}" scale="${this.scale}"
            rotate="${this.rotate}" speed="${this.speed}" blink="${this.blink}" blval="${this.blval}" path="${this.path}"></fractal-icon>`;
    }
    render() {
        return html`
            <div id="fractal-btn" class="fractal-btn"  tabindex="0" style="
