...
customElements.define('layout-app', class LayoutApp extends FractalElement {
    ...
    get topPanel() {
        return this._t ? html`
            <div style="border-bottom: ${this.border}; display: flex; align-items: center; justify-content: center">
                ${this._l ? html`<fractal-button size=28 br="none:50%" name="hamburger" fill="gray" ?toggled="${this._widthL <= this.minSize}" toggledClass="left90" style="padding:2px; cursor: pointer;z-index:2" @click="${this._hideL}"></fractal-button>` : ""}
                ...
                ${this._r ? html`<fractal-button size=28 br="none:50%" name="hamburger" fill="gray" ?toggled="${this._widthR <= this.minSize}" toggledClass="right90" style="padding:2px; cursor: pointer;z-index:2" @click="${this._hideR}"></fractal-button>` : ""}
            </div>
        ` : "";
    }
    get bottomPanel() {
